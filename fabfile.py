...
def _prepare_deploy():
	...
	os.chdir(env.home)
        ...
        for filu in ("jquery-1.7.1.min.js", "underscore-min.js", "backbone-min.js", "backbone-tastypie.js","jquery.lazyload.min.js", "jquery-ui-1.8.18.custom.min.js", "mustache.min.js"):
