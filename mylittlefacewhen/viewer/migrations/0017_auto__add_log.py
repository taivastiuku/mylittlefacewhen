...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Log'
        db.create_table('viewer_log', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='Warning:', max_length=256)),
            ('level', self.gf('django.db.models.fields.CharField')(default='I', max_length=1)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('viewer', ['Log'])


    def backwards(self, orm):
        
        # Deleting model 'Log'
        db.delete_table('viewer_log')
    ...
    models = {
        ...
        'viewer.log': {
            ...
            'text': ('django.db.models.fields.TextField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'default': "'Warning:'", 'max_length': '256'})
        },
        'viewer.salute': {
