...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feedback.useragent'
        db.add_column('viewer_feedback', 'useragent', self.gf('django.db.models.fields.CharField')(default='', max_length=512), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feedback.useragent'
        db.delete_column('viewer_feedback', 'useragent')
