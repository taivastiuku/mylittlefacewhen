...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feedback.text'
        db.alter_column('viewer_feedback', 'text', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feedback.text'
        db.alter_column('viewer_feedback', 'text', self.gf('django.db.models.fields.CharField')(max_length=256))
