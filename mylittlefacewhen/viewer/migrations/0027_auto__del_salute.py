...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'viewer_salute')


    def backwards(self, orm):
        # Adding model 'Salute'
        db.create_table(u'viewer_salute', (
    ...
    models = {
        ...
        u'viewer.changelog': {
            ...
            'flag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['viewer.Flag']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prev': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'next'", 'unique': 'True', 'null': 'True', 'to': u"orm['viewer.ChangeLog']"}),
