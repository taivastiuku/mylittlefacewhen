...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feedback.processed'
        db.add_column('viewer_feedback', 'processed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feedback.processed'
        db.delete_column('viewer_feedback', 'processed')
