...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Face.thumbname'
        db.delete_column('viewer_face', 'thumbname')

        # Deleting field 'Face.filename'
        db.delete_column('viewer_face', 'filename')

        # Deleting field 'Face.original'
        db.delete_column('viewer_face', 'original')

        # Changing field 'Face.image'
        db.alter_column('viewer_face', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256))

        # Changing field 'Face.webp'
        db.alter_column('viewer_face', 'webp', self.gf('django.db.models.fields.files.ImageField')(max_length=100))


    def backwards(self, orm):
        
        # Adding field 'Face.thumbname'
        db.add_column('viewer_face', 'thumbname', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)

        # Adding field 'Face.filename'
        db.add_column('viewer_face', 'filename', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)

        # Adding field 'Face.original'
        db.add_column('viewer_face', 'original', self.gf('django.db.models.fields.CharField')(default='', max_length=256), keep_default=False)

        # Changing field 'Face.image'
        db.alter_column('viewer_face', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Face.webp'
        db.alter_column('viewer_face', 'webp', self.gf('django.db.models.fields.BooleanField')())
