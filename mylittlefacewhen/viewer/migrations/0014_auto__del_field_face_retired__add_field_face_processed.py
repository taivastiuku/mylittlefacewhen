...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Face.retired'
        db.delete_column('viewer_face', 'retired')

        # Adding field 'Face.processed'
        db.add_column('viewer_face', 'processed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Face.retired'
        db.add_column('viewer_face', 'retired', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Face.processed'
        db.delete_column('viewer_face', 'processed')
