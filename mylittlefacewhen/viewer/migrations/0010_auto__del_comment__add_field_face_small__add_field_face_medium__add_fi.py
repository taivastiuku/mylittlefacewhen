...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Face.small'
        db.add_column('viewer_face', 'small', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)

        # Adding field 'Face.medium'
        db.add_column('viewer_face', 'medium', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)

        # Adding field 'Face.large'
        db.add_column('viewer_face', 'large', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)

        # Adding field 'Face.huge'
        db.add_column('viewer_face', 'huge', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        

        # Deleting field 'Face.small'
        db.delete_column('viewer_face', 'small')

        # Deleting field 'Face.medium'
        db.delete_column('viewer_face', 'medium')

        # Deleting field 'Face.large'
        db.delete_column('viewer_face', 'large')

        # Deleting field 'Face.huge'
        db.delete_column('viewer_face', 'huge')
