...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('viewer', ['Flag'])

        # Adding field 'Face.duplicate_of'
        db.add_column('viewer_face', 'duplicate_of', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['viewer.Face'], null=True), keep_default=False)

        # Adding field 'Face.removed'
        db.add_column('viewer_face', 'removed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Face.comment'
        db.add_column('viewer_face', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=512), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Flag'
        db.delete_table('viewer_flag')

        # Deleting field 'Face.duplicate_of'
        db.delete_column('viewer_face', 'duplicate_of_id')

        # Deleting field 'Face.removed'
        db.delete_column('viewer_face', 'removed')

        # Deleting field 'Face.comment'
        db.delete_column('viewer_face', 'comment')
