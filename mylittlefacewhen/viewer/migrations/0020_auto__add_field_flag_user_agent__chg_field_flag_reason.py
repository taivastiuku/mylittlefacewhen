...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Flag.user_agent'
        db.add_column('viewer_flag', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=512, null=True), keep_default=False)

        # Changing field 'Flag.reason'
        db.alter_column('viewer_flag', 'reason', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Deleting field 'Flag.user_agent'
        db.delete_column('viewer_flag', 'user_agent')

        # Changing field 'Flag.reason'
        db.alter_column('viewer_flag', 'reason', self.gf('django.db.models.fields.CharField')(max_length=512))
