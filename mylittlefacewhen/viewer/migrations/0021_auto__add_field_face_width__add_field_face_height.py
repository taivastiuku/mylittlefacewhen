...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Face.width'
        db.add_column('viewer_face', 'width', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Face.height'
        db.add_column('viewer_face', 'height', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Face.width'
        db.delete_column('viewer_face', 'width')

        # Deleting field 'Face.height'
        db.delete_column('viewer_face', 'height')
