...
class FaceResource(PieforkModelResource):
    ...
    class Meta:
        ...
        description = """Resource that contains all the reaction images in \
            the service. Allows uploading base64 formatted images and \
...
class TagResource(PieforkModelResource):
    ...
    class Meta:
        ...
        description = """Listing of all the tags in service, can be used to \
            determine what tags are available. New tags should be added \
            straight to face resources."""
...
class DetectResource(PieforkResource):
    ...
    class Meta:
        ...
        detail_allowed_methods = []
        description = """Try to detect source and tags of new image, \
            useful when adding new images."""
